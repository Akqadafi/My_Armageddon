...
# # Explanation: This bucket is arcanum’s incident archive—postmortems go here, not into Slack void.
...
# # Explanation: arcanum blocks public access—incident reports are not fan fiction for the public internet.
...
# # Explanation: arcanum grants the minimum needed—logs, S3, SSM, Secrets, CloudWatch, and Bedrock invoke.
...
#         ],
#         Resource = "arn:aws:ssm:*:${data.aws_caller_identity.arcanum_self01.account_id}:parameter/lab/db/*"
#       },
#       # Secrets Manager
#       {
#         Effect = "Allow",
...
#         ],
#         Resource = "arn:aws:secretsmanager:*:${data.aws_caller_identity.arcanum_self01.account_id}:secret:${var.project_name}/rds/mysql*"
#       },
#       # S3 report write
#       {
#         Effect = "Allow",
...
# # Explanation: Attach the policy—arcanum equips the Lambda like a proper Wookiee engineer.
...
# # Explanation: The Lambda itself—arcanum’s incident scribe that writes your postmortem while you fight fires.
...
#       SNS_TOPIC_ARN        = aws_sns_topic.arcanum_sns_topic01.arn
#     }
#   }
# }
...
# # Explanation: Allow SNS to invoke Lambda—arcanum authorizes the distress beacon to wake the droid.
...
#   source_arn    = aws_sns_topic.arcanum_sns_topic01.arn
# }

# # Explanation: Output report bucket—arcanum needs the archive coordinates for grading.
